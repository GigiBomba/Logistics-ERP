...
> **CLOSE-OUT NOTE (2026-09-19):** all 20 findings are CLOSED or documented-debt as of
> this batch. Archive reason: fully-implemented + residuals documented — RADIUS_XL
> visual parity (G1 2026), 3px/5px micro-tunings in theme_engine/dispatch_alerts_panel
> (grandfathered), 640 inline-QSS grandfather. Moved from repo root to
> `archive/completed/` on 2026-09-19.
