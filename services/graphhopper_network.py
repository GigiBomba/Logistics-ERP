...
DEFAULT_GRAPHHOPPER_BASE_URL = "https://maps.operionerp.xyz"

MAX_ROUTE_RETRIES = 5
RETRY_BACKOFF_SECONDS = (1.0, 2.0, 4.0, 8.0, 15.0)
...
def should_use_post_routing(
    *,
    ...
    if point_count > 2:
        return True
    return estimated_distance_km >= POST_DISTANCE_THRESHOLD_KM
...
def is_retryable_request_error(exc: BaseException) -> bool:
    ...
    return bool(isinstance(exc, (requests.exceptions.Timeout, requests.exceptions.ConnectionError)))
