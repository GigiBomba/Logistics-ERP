...
class TripCalculator:
    @staticmethod
    def calculate(km, price_eur, fuel_price, days, consum_litri, extra_in=None, sal_in=0, taxa_in=0, fuel_cost_override=None):
        ...
        # 3. Costuri extra (Automat 0.03€/km + 12€/zi dacă e None)
