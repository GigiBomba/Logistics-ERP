...
class LineItemsMixin:
    ...
    def _build_totals_section(self) -> None:
        ...
        self._canvas_subtotal_label = QLabel(t("common.zero_eur"))
        ...
        self._canvas_tax_label = QLabel(t("common.zero_eur"))
        ...
        self._canvas_discount_label = QLabel(t("common.zero_eur"))
        ...
        self._canvas_grand_label = QLabel(t("common.zero_eur"))
