...
def calc_view(qt_widget, qtbot, monkeypatch):
    ...
    monkeypatch.setattr("ui.qt_views.qt_calculator_view.Toast.show_success", lambda *a, **k: None)
...
class TestQtCalculatorView:
    ...
    def test_calculate_displays_result(self, calc_view, qtbot, monkeypatch):
        monkeypatch.setattr("ui.qt_views.qt_calculator_view.QMessageBox", MagicMock())
